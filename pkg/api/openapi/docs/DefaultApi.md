...
[**ApiRhTrexV1KindnamesGet**](DefaultApi.md#ApiRhTrexV1KindnamesGet) | **Get** /api/rh-trex/v1/kindnames | Returns a list of kindnames
[**ApiRhTrexV1KindnamesIdGet**](DefaultApi.md#ApiRhTrexV1KindnamesIdGet) | **Get** /api/rh-trex/v1/kindnames/{id} | Get an kindname by id
[**ApiRhTrexV1KindnamesIdPatch**](DefaultApi.md#ApiRhTrexV1KindnamesIdPatch) | **Patch** /api/rh-trex/v1/kindnames/{id} | Update an kindname
[**ApiRhTrexV1KindnamesPost**](DefaultApi.md#ApiRhTrexV1KindnamesPost) | **Post** /api/rh-trex/v1/kindnames | Create a new kindname
...
## ApiRhTrexV1KindnamesGet

> KindNameList ApiRhTrexV1KindnamesGet(ctx).Page(page).Size(size).Search(search).OrderBy(orderBy).Fields(fields).Execute()

Returns a list of kindnames
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DefaultApi.ApiRhTrexV1KindnamesGet(context.Background()).Page(page).Size(size).Search(search).OrderBy(orderBy).Fields(fields).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DefaultApi.ApiRhTrexV1KindnamesGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ApiRhTrexV1KindnamesGet`: KindNameList
    fmt.Fprintf(os.Stdout, "Response from `DefaultApi.ApiRhTrexV1KindnamesGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiRhTrexV1KindnamesGetRequest struct via the builder pattern
...
## ApiRhTrexV1KindnamesIdGet

> KindName ApiRhTrexV1KindnamesIdGet(ctx, id).Execute()

Get an kindname by id
...
func main() {
    ...
    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DefaultApi.ApiRhTrexV1KindnamesIdGet(context.Background(), id).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DefaultApi.ApiRhTrexV1KindnamesIdGet``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ApiRhTrexV1KindnamesIdGet`: KindName
    fmt.Fprintf(os.Stdout, "Response from `DefaultApi.ApiRhTrexV1KindnamesIdGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiRhTrexV1KindnamesIdGetRequest struct via the builder pattern
...
## ApiRhTrexV1KindnamesIdPatch

> KindName ApiRhTrexV1KindnamesIdPatch(ctx, id).KindNamePatchRequest(kindNamePatchRequest).Execute()
...
func main() {
    id := "id_example" // string | The id of record
    kindNamePatchRequest := *openapiclient.NewKindNamePatchRequest() // KindNamePatchRequest | Updated kindname data

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DefaultApi.ApiRhTrexV1KindnamesIdPatch(context.Background(), id).KindNamePatchRequest(kindNamePatchRequest).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DefaultApi.ApiRhTrexV1KindnamesIdPatch``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ApiRhTrexV1KindnamesIdPatch`: KindName
    fmt.Fprintf(os.Stdout, "Response from `DefaultApi.ApiRhTrexV1KindnamesIdPatch`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiRhTrexV1KindnamesIdPatchRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **kindNamePatchRequest** | [**KindNamePatchRequest**](KindNamePatchRequest.md) | Updated kindname data | 
...
## ApiRhTrexV1KindnamesPost

> KindName ApiRhTrexV1KindnamesPost(ctx).KindName(kindName).Execute()
...
func main() {
    kindName := *openapiclient.NewKindName() // KindName | KindName data

    configuration := openapiclient.NewConfiguration()
    apiClient := openapiclient.NewAPIClient(configuration)
    resp, r, err := apiClient.DefaultApi.ApiRhTrexV1KindnamesPost(context.Background()).KindName(kindName).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DefaultApi.ApiRhTrexV1KindnamesPost``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `ApiRhTrexV1KindnamesPost`: KindName
    fmt.Fprintf(os.Stdout, "Response from `DefaultApi.ApiRhTrexV1KindnamesPost`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiApiRhTrexV1KindnamesPostRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **kindName** | [**KindName**](KindName.md) | KindName data | 
